      ...
      <div class="container">
        ...
        <form class="lead-form" id="leadForm" aria-live="polite" data-origen="{slug}">
          ...
          <div class="lead-form-row">
            ...
            <input id="leadEmail" type="email" name="email" placeholder="you@email.com" required autocomplete="email" inputmode="email">
            <button type="submit">I want in</button>
          </div>
          <label class="lead-check lead-privacy">
            <input type="checkbox" name="privacyAcknowledged" required>
            <span>Acepto que Origenes Coffee guarde mi email y atribucion de campana para responder a esta lista. Politica de privacidad: [PENDIENTE: correo de privacidad] · [PENDIENTE: responsable del sitio]</span>
          </label>
          <label class="lead-check">
            <input type="checkbox" name="marketingConsent">
            <span>Quiero recibir historias, lanzamientos y pruebas de producto por email.</span>
          </label>
          <p class="lead-error" role="alert" hidden>No pudimos guardar tu email. Intentalo de nuevo.</p>
        </form>
